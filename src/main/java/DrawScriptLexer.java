...
public class DrawScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "OPERATORADD", "OPERATORMULT", "LOGICOPERATOR", 
			"PROP", "CONST", "LITERAL", "OPEN_INTERVAL", "CLOSE_INTERVAL", "BOOL", 
			"OPERATOR", "TIMES", "PLUS", "DIV", "MINUS", "MOD", "EQUAL", "DIF", "LESS", 
			"GREATER", "COMMENT", "WS"
		};
	}
